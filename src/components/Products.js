                ...
                <div className="Products">
                    <div className="container">
                        ...
                        <div className="Game">
                            ...
                            <div className="ProductsColumn">
                                <div className="ProductsInfo">
                                    <p>Alias is a board game, where the objective of the players is to explain words to each
                        ...
                        <div className="Game">
                            <div className="ProductsColumn" >
                                <div className="ProductsInfo">
                                    <p>2048 is a single-player sliding block puzzle game designed by Italian web
                        ...
                        <div className="Game">
                            ...
                            <div className="ProductsColumn" >
                                <div className="ProductsInfo">
                                    <p>This game is in active development stage. Follow all the news in our Telegram channel.
                                    </p>
                                    <button>
                                        <a href="#ff"> Download </a>
                                    </button>
